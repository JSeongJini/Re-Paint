...
public class KnightsSpawner : MonoBehaviour
{
    ...
    [SerializeField] private Transform knightHolder = null;

    [Header("Customizing")]
    [SerializeField] private KnightCustomizer customizer = null;
    [SerializeField] private KnightCustomizer.HeadObject head = KnightCustomizer.HeadObject.Pilosity;
    [SerializeField] private KnightCustomizer.Weapon weapon = KnightCustomizer.Weapon.Longsword;
    [SerializeField] private KnightCustomizer.Shield shield = KnightCustomizer.Shield.Shield_Type02;
    [SerializeField] private KnightCustomizer.CoatOfArms coat = KnightCustomizer.CoatOfArms.CoatOfArms_type02;
    [SerializeField] private KnightCustomizer.KnightBase body = KnightCustomizer.KnightBase.Type00;
